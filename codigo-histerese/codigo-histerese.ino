...
double temperatura;
double setPoint_resistencia = 26.0;
double input;
...
bool resistenciaLigada = 0;  // Estado da resistência (ligada ou desligada)
...
void loop() {
    ...
    if (currentMillis - tempoAnterior >= intervaloPID) {
        ...
        //input = temperaturaCorrigida - 5.5;
        float temperaturaAmbiente = lerTemperaturaLM35();
        input = temperaturaAmbiente;
